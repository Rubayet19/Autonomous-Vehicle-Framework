...
DOCKER_ARGS+=("-e FASTRTPS_DEFAULT_PROFILES_FILE=/usr/local/share/middleware_profiles/husarnet_fastdds_profile.xml")
...
docker run -it --rm \
    ...
    -v /dev/right_cam:/dev/right_cam \
    -v /dev/left_cam:/dev/left_cam \
    -v /dev/front_cam:/dev/front_cam \
